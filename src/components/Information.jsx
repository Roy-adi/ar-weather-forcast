...
import { LocationOn, SettingsBrightness, Opacity, Brightness5, Brightness6, Dehaze, Cloud , Thermostat} from '@mui/icons-material'
...
const Information = ({result})=>{
    return(
        ...
        <Row><Thermostat />feels_like: {result.main.feels_like}</Row>
